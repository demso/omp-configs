---
name: "focused-fix"
description: "Use when the user asks to fix, debug, or make a specific feature/module/area work end-to-end. Triggers: 'make X work', 'fix the Y feature', 'the Z module is broken', 'focus on [area]'. Not for quick single-bug fixes (use systematic-debugging) and not for pure cause-hunting (use diagnosing-bugs) — this is for systematic deep-dive repair across all files and dependencies."
---
